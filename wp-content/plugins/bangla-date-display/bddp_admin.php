...
<div class="inside"><p align="justify">Display post/page's time, date, comment count, dashboard numbers, archive calendar etc in Bangla language. Choose which you want to be displayed in Bangla language.
    <table class="form-table">
        ...
        <td colspan="3">
        <input id="bddp_options[trans_dt]" type="checkbox" name="bddp_options[trans_dt]" value="1" <?php if(isset($bddp_options['trans_dt'])==1) echo('checked="checked"'); ?>/><label for="bddp_options[trans_dt]">All Date/Time</label>
		</td>
        </tr>
        <tr valign="top">
        <td></td>
        <td><input id="bddp_options[trans_cmnt]" type="checkbox" name="bddp_options[trans_cmnt]" value="1" <?php if(isset($bddp_options['trans_cmnt'])==1) echo('checked="checked"'); ?>/><label for="bddp_options[trans_cmnt]">Comment Count</label></td>
        <td><input id="bddp_options[trans_num]" type="checkbox" name="bddp_options[trans_num]" value="1" <?php if(isset($bddp_options['trans_num'])==1) echo('checked="checked"'); ?>/><label for="bddp_options[trans_num]">Dashboard Numbers</label></td>
        <td><input id="bddp_options[trans_cal]" type="checkbox" name="bddp_options[trans_cal]" value="1" <?php if(isset($bddp_options['trans_cal'])==1) echo('checked="checked"'); ?>/><label for="bddp_options[trans_cal]">Archive Calendar</label></td>
        </tr>
    </table>
</div></div>

<div class="postbox">
	<h3 class="hndle" style="padding: 10px; margin: 0;"><span>Date/Time Settings</span></h3>
...
<div class="postbox">
	<h3 class="hndle" style="padding: 10px; margin: 0; text-align: center;"><span>Avertisement</span></h3>
	<div class="inside">
        <p align="center">
            <a target="_blank" href="http://xhostbd.com"><img src="http://xhostbd.com/advertisements/advert1.jpg"/></a>
        </p>
	</div>
</div>
...
<div class="postbox">
    ...
    Web: <a href="http://i-onlinemedia.net">www.i-onlinemedia.net</a> - <a href="http://xhostbd.com">www.xhostbd.com</a></p><br/>
