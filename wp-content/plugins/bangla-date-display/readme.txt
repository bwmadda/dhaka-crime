...
= 8.5.2 =
* Bug fixed. Now [hijri_date] shortcode can be used more than once in a page.
* More simplified settings page.
* Tested compatibility with WP 4.7.

= 8.5.1 =
* Bug fixed. Now all shortcodes can be used in a single line without any problem. Example: [bangla_date] [english_date] [hijri_date].... etc.
